...
use crate::graphics::{
    DrawMode, ShaderDescription, TextureSection, VertexAttribute, VertexDescriptor, VertexInputType,
    VertexInstancing, VertexOutputType,
};
use crate::math::AABB2D;
use cgmath::*;

/// Configuraiton for the sprite shader.
pub const SPRITE_SHADER: ShaderDescription = ShaderDescription {
